...
void UsaLetras::menú()
{
    int tam, opc, pos, *arregloPosiciones; //Se declaran las variables a utilizar
    string letra; 
    Validaciones val; //Se crea un objeto de la clase Validaciones
    tam=stoi(val.leerI(0,"Digite el tamaño del arreglo de letras: "));
    Letras letras=Letras(tam); //Se crea un objeto de la clase Letras
    do
    {
